...
router.get('/auth/discord/login', async ctx => {
  const url =
    'https://discord.com/api/oauth2/authorize?client_id=1132803317597229110&redirect_uri=http%3A%2F%2Flocalhost%3A4000%2Fauth%2Fdiscord%2Fcallback&response_type=code&scope=identify';
